...
<html lang="en">
    <head>
        ...
        <title>Halaman Belum Tersedia - ReuseHub</title>
        ...
        <section class="min-h-screen bg-gradient-to-br from-gray-50 to-white flex items-center justify-center py-12">
            <div class="max-w-md mx-auto px-6 text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <button onclick="window.history.back()" class="bg-green-600 hover:bg-green-700 text-white font-semibold px-20 py-3 rounded-lg transition duration-200">
                        Halaman Sebelumnya
                    </button>
                </div>
